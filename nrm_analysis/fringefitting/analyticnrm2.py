...
def ASFhex(pixel, fov, oversample, ctrs, d, lam, phi, centering = 'PIXELCENTERED', verbose = False):
...
def PSF(pixel, fov, oversample, ctrs, d, lam, phi, centering = 'PIXELCENTERED', shape = 'circ',verbose=False):
