...
class NRM_Model():
    ...
    def __init__(self, mask=None, holeshape="circ", pixscale=mas2rad(64), rotate=False, \
            ...
            datapath="",
            scallist = None, rotlist_deg = None, phi="perfect", refdir="", verbose=False):
        """
...
#             except AttributeError:
    ...
    def simulate(self, fov=None, bandpass=None, over=None, \
        pixweight=None,pixel=None,rotate=False, centering = "PIXELCENTERED", verbose=False):
        """
        ...
        # The monochromatic case if bandpass input is a single wavelength
            ...
            self.psf_over = analyticnrm2.PSF(self.pixel_sim, self.fov_sim, 
                        ...
                        shape=self.holeshape,verbose=centering)
    ...
    def make_model(self, fov=None, bandpass=None, over=False,centering='PIXELCENTERED',
                pixweight=None, pixscale=None,rotate=False, flip=False, verbose=False):
        if verbose:
    ...
    def auto_find_center(self, modelfitsname, overwrite=1, verbose=False):
        """
    ...
    def find_location_of_peak(self, verbose=False):
